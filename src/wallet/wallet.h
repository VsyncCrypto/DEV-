...
enum ZerocoinSpendStatus {
    ...
    ZVSX_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
    ...
    ZVSX_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
...
public:
    ...
    /// Get 10000 VSX output and keys which can be used for the Masternode
    ...
    void doZVsxRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZVSX);
    ...
    bool CreateZVSXOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
