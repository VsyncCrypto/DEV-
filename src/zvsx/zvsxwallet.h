...
#ifndef VSYNC_ZVSXWALLET_H
#define VSYNC_ZVSXWALLET_H
...
public:
    ...
    void GenerateDeterministicZVSX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVSX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
