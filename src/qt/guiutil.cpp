...
QString formatBalance(CAmount amount, int nDisplayUnit, bool isZvsx)
{
    return (amount == 0) ? ("0.00 " + BitcoinUnits::name(nDisplayUnit, isZvsx)) : BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, amount, false, BitcoinUnits::separatorAlways, true, isZvsx);
}
