    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableVSX,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableVSX,
    ...
    connect(ui->pushButton_UnspendableVSX, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableVSX);});
