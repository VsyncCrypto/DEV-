VSYNC Core version *3.3.0* is now available from:  <https://github.com/vsync-project/vsync/releases>
...
Moving forward from this undesired situation, we are enabling a secure and chain storage friendly solution for the zerocoin public spend (aka zVSX to VSX conversion).
...
Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://github.com/VSYNC-Project/VSYNC/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.
...
### Core
 ...
 - #891 `855408c2c3` [ZVSX] Zerocoin public coin spend. (furszy)
