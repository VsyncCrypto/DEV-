VSYNC Core version *3.2.0* is now available from:  <https://github.com/vsync-project/vsync/releases>
...
### GUI
 ...
 - #655 `de0c4e0888` [Qt] Fix VSX balances on overview page (Fuzzbawls)
