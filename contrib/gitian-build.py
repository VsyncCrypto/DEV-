...
def setup_repos():
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vsync-Project/gitian.sigs.git'])
    if not os.path.isdir('vsync-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vsync-Project/vsync-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('vsync'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vsync-Project/vsync.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/vsync-Project/vsync', help='Specify the URL of the repository. Default is %(default)s')
